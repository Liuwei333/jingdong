...
public class MyLinAdapter extends RecyclerView.Adapter{
    Context context;
    List<ShouYeBean.MiaoshaBean.ListBeanX> data;
    public MyLinAdapter(Context context, List<ShouYeBean.MiaoshaBean.ListBeanX> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //导入一个xml布局文件
        View view = View.inflate(context, R.layout.linerarxml, null);
